...
package org.hopestarter.wallet.service;
...
import org.hopestarter.wallet.ui.MainTabbedActivity;
...
public class BlockchainServiceImpl extends android.app.Service implements BlockchainService
{
	...
	private void notifyCoinsReceived(@Nullable final Address address, final Coin amount)
	{
		...
		notification.setContentIntent(PendingIntent.getActivity(this, 0, new Intent(this, MainTabbedActivity.class), 0));
